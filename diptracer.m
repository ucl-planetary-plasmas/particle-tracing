function diptracer(planet,Ep,Ri,ai,timespec,savefile)
% function diptracer(planet,Ep,Ri,ai,timespec,savefile)
%
...
% For instance 
%
%   diptracer('earth',10,4,30,[0,0,2,0],'my_earth_dip_sim');
%
% runs the Boris algorithm, and guiding centre approximation in Earth's
% dipole for a proton of 10 MeV at initial position 4 Rp and
% pitch angle 30 deg for 2*tb, i.e. two bounce periods, and save the
% simulation data in file 'my_earth_dip_sim.mat'.
%
% Similarly for Jupiter and Saturn dipole approximation but for a
% 100 MeV proton at initial position 4 Rp and pitch angle 30 deg
%
%   diptracer('jupiter',100,4,30,[0,0,1,0]);
%   diptracer('saturn',100,4,30,[0,0,1,0]);
%
% but don't save the simulation data.

%
% $Id: diptracer.m,v 1.2 2018/06/17 18:29:49 patrick Exp $
%
